...
ActionResults Action::execute(ActionResults resultFrame, Fight* activeFight, std::vector<Targets> targets)
{
	resultFrame = performAction(targets, activeFight, resultFrame);
...
std::vector<Targets> Action::findTargets(FightPos attackerPos, Fight* activeFight, BoonFightContainer traits)
{
	unsigned int i, j;
