...
if __name__ == "__main__":
    thingName = "InspiringHeroism"
    thingNameSwedish = "Smittande hjältemod"
    swedishDescription = "Alla döende vänner utför ett sista anfall innan de dör."
    englishDescription = "Any dying ally performs one last attack before they die."
    isTriggerable = True
    isBoon=True
    isMajor = True
